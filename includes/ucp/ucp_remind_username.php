...
class ucp_remind_username
{
	...
	function main($id, $mode)
	{
		...
		if ($submit)
		{
			...
			$message = $user->lang['USERNAME_SENT'] . '<br /><br />' . sprintf($user->lang['RETURN_INDEX'], '<a href="' . append_sid("{$phpbb_root_path}index.$phpEx") . '">', '</a>');
		...
		$template->assign_vars(array(
			'USERNAME'			=> $username,
			'EMAIL'				=> $email,
			'S_PROFILE_ACTION'	=> append_sid($phpbb_root_path . 'ucp.' . $phpEx, 'mode=sendusername'))
		);

		$this->tpl_name = 'ucp_remind_username';
		$this->page_title = 'UCP_REMIND_USERNAME';
	}
}
