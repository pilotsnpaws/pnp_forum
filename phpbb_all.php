...
echo '<tr><td>' . mysql_result($result,$i,"phpbb_users.user_id") . '</td>'
       . '<td>' . mysql_result($result,$i,"phpbb_users.username")  . '</td>'
       . '<td>' . mysql_result($result,$i,"phpbb_profile_fields_data.pf_zip_code")  . '</td>'
       . '<td>' . mysql_result($result,$i,"phpbb_profile_fields_data.pf_foster_yn")  . '</td>'
       . '<td>' . mysql_result($result,$i,"phpbb_profile_fields_data.pf_airport_id")  . '</td>'
       . '<td>' . mysql_result($result,$i,"phpbb_profile_fields_data.pf_pilot_yn")  . '</td>'
       ...
       . '<td>' . mysql_result($result,$i,"phpbb_profile_fields_data.pf_emergency_contact")  . ' &nbsp</td>'
