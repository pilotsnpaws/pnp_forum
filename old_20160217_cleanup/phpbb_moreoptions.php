...
echo '<a href="http://maps.google.com/maps?q=http://www.pilotsnpaws.org/forum/phpbb_kml5.php?fromzip=' . $fromzip . $tozip . '">' .
"Display Map of Transport Route between $fromcity $fromstate and $tocity $tostate</a><br>" ;

// END MOD

echo '<a href="http://www.pilotsnpaws.org/forum/phpbb_kml2a.php?fromzip=' . $fromzip . $tozip . '">' .
"List Pilots between $fromcity $fromstate and $tocity $tostate</a><br>" ;
echo '<a href="http://www.pilotsnpaws.org/forum/phpbb_kml2a.php?fromzip=' . $fromzip . $fromzip . '">' .
"List Pilots near  $fromcity $fromstate</a><br>" ;

echo '<a href="http://www.pilotsnpaws.org/forum/phpbb_kml2a.php?fromzip=' . $tozip . $tozip . '">' .
"List Pilots near  $tocity $tostate</a><br>" ;

echo '<a href="http://www.pilotsnpaws.org/forum/phpbb_kml3a.php?fromzip=' . $fromzip . $tozip . '">' .
"List Volunteers between $fromcity $fromstate and $tocity $tostate</a><br>" ;
echo '<a href="http://www.pilotsnpaws.org/forum/phpbb_kml3a.php?fromzip=' . $fromzip . $fromzip . '">' .
"List Volunteers near  $fromcity $fromstate</a><br>" ;

echo '<a href="http://www.pilotsnpaws.org/forum/phpbb_kml3a.php?fromzip=' . $tozip . $tozip . '">' .
