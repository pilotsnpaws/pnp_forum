...
$help = array(
	...
	array(
		...
		1 => 'The paperwork we suggest for our pilots to request is a health certificate and an up-to-date proof of vaccine, rabies in particular.  It is up to each pilot if they would like any further information.  Click to check the <a href="http://www.aphis.usda.gov/import_export/animals/animal_import/animal_imports_states.shtml" style="text-decoration: underline" target="_blank">requirements</a> for each state the flight will pass through.',
	),
	array(
		0 => '--',
		1 => 'Expenses',
