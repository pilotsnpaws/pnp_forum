...
//-- mod : Forgot username ------------------------------------------------------------
//-- replacement
if (in_array($mode, array('login', 'logout', 'confirm', 'sendpassword', 'sendusername', 'activate')))
{
...
switch ($mode)
{
	...
	//-- add
	case 'sendusername':
		$module->load('ucp', 'remind_username');
		$module->display($user->lang['UCP_REMIND_USERNAME']);
	break;
	//-- fin mod : Forgot username --------------------------------------------------------
