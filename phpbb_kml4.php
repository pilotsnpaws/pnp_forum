...
. "60 * degrees(acos(sin(radians(airports.lat)) * sin(radians($fromlat)) + cos(radians(airports.lat)) * cos(radians($fromlat)) * cos(radians(airports.lon - $fromlon)))) + 

60 *  degrees(acos(sin(radians(airports.lat)) * sin(radians($tolat)) + cos(radians(airports.lat)) * cos(radians($tolat)) * cos(radians(airports.lon - $tolon)))) - 

60 *  degrees(acos(sin(radians($tolat)) * sin(radians($fromlat)) + cos(radians($tolat)) * cos(radians($fromlat)) * cos(radians($tolon - $fromlon)))) < 200";
/*
...
*/
    ...
    echo '<?xml version="1.0" encoding="UTF-8"?>
		 ...
		 <Document>
				   ...
				   <description>
				      <![CDATA[Pilots N Paws - Pilot Locations www.pilotsnpaws.org]]>
				   </description>';
