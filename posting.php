...
//$pnp5k	= (!empty($post_data['pnp_Transfer'])) ? (int) $post_data['pnp_Transfer'] : 0;
...
$pnptransport = (($forum_id == 5 ) && ($mode == 'post' || ($mode == 'edit' && $post_data['topic_first_post_id'] == $post_data['post_id'])));
//$pnp5k = (($forum_id == 15 ) && ($mode == 'post'));

//Edit not saving data - no time to fix
...
// only display topic icons to the original topic starter or 
// admins and mods
if ($s_topic_icons && $mode != 'post' && !$auth->acl_gets('a_','m_') && 
